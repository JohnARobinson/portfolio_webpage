  ...
  return (
    <nav>
      <div className='nav__navbar'>
          ...
          <a href="JohnRobinson2023Resume.docx" download>Resume</a>
          <div class="Project-Dropdown">
              <NavLink className="nav-link" to="/Projects">Project Portfolio's</NavLink>
              <div class="Project-Content">
                ...
                <NavLink className="nav-link" to="/Threedmodel">Machine Learning Projects</NavLink>
